...
let Product = {
  render: async () => {
    ...
    let productData = await getProduct(request.id);
                    ...
                    <div class="lg:w-4/5 mx-auto flex flex-wrap">
                        ...
                        <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                            ...
                            <div class="flex productWrapper">
                                ...
                                <button
                                    class="flex ml-auto px-6 py-2 transition ease-in duration-200 uppercase rounded-full hover:bg-gray-800 hover:text-white border-2 border-gray-900 focus:outline-none" id="addToCart">Add
                                to cart</button>
